...
RSpec.describe ViewCheckoutsJob do
  ...
  context 'when SymphonyClient does not respond with 200/OK' do
    before do
      stub_request(:get, 'https://example.com/symwsbc/user/patron/key/patron2?includeFields=*,customInformation{' \
                         'patronExtendedInformation{*}},address1,circRecordList%7B*,bib%7Btitle,author,callList%7B*%7D%7D,' \
